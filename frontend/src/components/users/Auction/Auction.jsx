                            ...
                            <div>
                                <div className="d-flex justify-content-evenly p-2">
                                    ...
                                    <div className="m-2 p-3">
                                        ...
                                        <div className='mb-2'> <span className='fs-6'>Start date:</span> {ProductData.start_date_now}</div>
                                        <div className='mb-2'> <span className='fs-6'>End date:</span> {ProductData.end_date_now}</div>
